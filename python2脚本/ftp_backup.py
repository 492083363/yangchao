...
dic = {
    ...
    'jingzhouQinQ': ['192.168.200.10',
                     ...
                     '192.168.200.15',
                     '192.168.200.16'],
    'jiancewang': ['172.31.218.2', '172.31.218.3'],
    'guoganjiance': ['172.31.220.2', '172.31.220.3'],
    'tongjiyiyuan': ['172.31.219.2'],
    'tushuguan': ['172.31.211.2'],
    'zhuanwang': ['172.31.214.2'],
	'dishui':['172.31.216.12','172.31.216.13','172.31.216.11']
}


def save(hosts, ftp):
    url = '/root/backup_new/{}'.format(hosts)
    ...
    for host in dic[hosts]:
	    ...
	    print host + " ftp down ok"
            ...
            print '{} is loss , msg:-{}'.format(host, e)
